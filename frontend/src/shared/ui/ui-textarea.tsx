...
import { PropsWithRef, TextareaHTMLAttributes, useId } from 'react'
	...
	return (
		<div className={clsx(className, 'flex flex-col gap-1')}>
			...
			<textarea
				...
				id={id}
				className={clsx(textareaProps?.className, 'rounded-md h-20 border resize-none outline-none px-3 py-2')}
			/>
		</div>
	)
}
